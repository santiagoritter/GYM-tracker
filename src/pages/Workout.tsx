...
export default function Workout() {
  ...
  if (screen.kind === 'results') {
    ...
    return (
      <div className="mx-auto flex min-h-screen content-width flex-col items-center justify-center gap-6 px-6 pb-10 pt-[calc(2.5rem+env(safe-area-inset-top))] text-center">
        {celebrate && <Confetti />}
  ...
  if (screen.kind === 'preview') {
    ...
    return (
      <div className="mx-auto flex min-h-screen content-width flex-col gap-6 px-6 pb-10 pt-[calc(2.5rem+env(safe-area-inset-top))]">
